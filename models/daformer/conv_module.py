...
def build_conv_layer(cfg: Optional[Dict], *args, **kwargs) -> nn.Module:
    ...
    # print("build_conv_layer", cfg, "###", args, "###", kwargs)
    ...
    def __init__(self,
        ...
        if self.with_norm:
            ...
            if norm_cfg["type"] == "BN":
                ...
                norm = LayerNorm2d(norm_channels)
                self.norm_name = "ln"
            else:
                raise Exception("Unknown norm: {}".format(str(norm_cfg)))
        ...
        if self.with_activation:
            ...
            if act_cfg_['type'] == 'ReLU':
                self.activate = torch.nn.ReLU(inplace=True)  # build_activation_layer(act_cfg_)
            else:
                raise Exception("act_cfg: {}".format(str(act_cfg_)))
