...
class SupervisedVITHRDA(lightning.LightningModule):
    def __init__(
            self,
            batch_size: int,
            img_size: int,
    ...
    def train_dataprep(self, batch):
        ...
        sourceds_aug_image = self.random_aug_weak(sourceds_image.detach().clone().float() / 255.)

        return sourceds_aug_image, sourceds_target
    ...
    def training_step(
        ...
        # data prep
        ##
        sourceds_aug_image, sourceds_aug_target = self.train_dataprep(batch)
